...
class Grupo extends Entity {
   ...
   protected $fillable   = ['id','curso_id', 'carrera_id', 'materia_id', 'descripcion', 'docente_id', 'nuevo', 'turno_manana', 'turno_tarde', 'turno_noche', 'sabados', 'fecha_inicio', 'fecha_fin' , 'filial_id', 'activo', 'terminado', 'cancelado', 'color'];
