		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Bienvenido <strong>{!!$director->nombres!!} {!!$director->apellidos!!}</strong>  a su perfil</h3>
				</div>
				<div class="box-body">
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="col-md-6 form-group">
								<label>Cuenta de director</label>
								@foreach ($mail as $m)
									{!! Form::text(null, $m->mail, array('class'=>'form-control','disabled')) !!}		
								@endforeach
