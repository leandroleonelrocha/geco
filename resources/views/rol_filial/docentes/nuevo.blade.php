					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="col-md-6 form-group">
								...
								<div class="col-xs-12">
									{!! Form::checkbox('disponibilidad_manana', '1',null, array('class'=>'flat-red')) !!} @lang('docente.mañana')
								</div>
								<div class="col-xs-12">
									{!! Form::checkbox('disponibilidad_tarde', '1',null, array('class'=>'flat-red')) !!} @lang('docente.tarde')
								</div>
								<div class="col-xs-12">
									{!! Form::checkbox('disponibilidad_noche', '1',null, array('class'=>'flat-red')) !!} @lang('docente.noche')
								</div>
								<div class="col-xs-12">
									{!! Form::checkbox('disponibilidad_sabados', '1',null, array('class'=>'flat-red')) !!} @lang('docente.sabados')
								</div>
							</div>
